function vf_ = model_new_one(t,x,p1,q)
...
m      = 10^p1(7);      %    Maintenance term  
K_M    = 10^p1(8);      %    Michaelis menten constant (mmol C cm-3) 
a_CO2  = 10^p1(9);      % ** Rate of NER decay 
f_1    = 10^p1(10);     %    Conversion factor [carbon/gene]

% FUNCTION PARAMETERS 
Q10    = p1(11);        %    Temperature function constant
