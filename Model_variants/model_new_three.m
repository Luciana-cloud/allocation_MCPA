function vf_ = model_new_three(t,x,p1,q)
...
% initial concentration = 1 mg/Kg
% humidity level        = pF 1.8
...
f_T    = 10^p1(20);      % *  Conversion factor [transcripts/gene]
n_H    = p1(21);         % *  Hill coeficient  [1]
K_G    = 10^p1(22);      %    Activation coefficient of MCPA for gene expression [mmol C cm-3]
mu_max = 10^p1(23);      % *  Maximal specific growth rate of bacterial pesticide degraders bacteria A [d-1]
a_a    = 10^p1(5);       % ** Decay rate of active?DNA?_tfdA [d-1]
Y_P    = p1(24);         %    Substrate (MCPA)uptake efficiency of by bacterial pesticide degraders [1]
m      = 10^p1(25);      %    Maintenance term 
K_M    = 10^p1(26);      %    Michaelis menten constant (mmol C cm-3)
a_CO2  = 10^p1(9);       % ** Rate of NER decay
f_1    = 10^p1(27);      %    Conversion factor [carbon/gene]

% FUNCTION PARAMETERS 

Q10      = p1(28);       %    Temperature function constant
