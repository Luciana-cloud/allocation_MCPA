function vf_ = model_new_four(t,x,p1,q)
...
K_G    = 10^p1(29);      %    Activation coefficient of MCPA for gene expression [mmol C cm-3]
...
Y_P    = p1(30);         %    Substrate (MCPA)uptake efficiency of by bacterial pesticide degraders [1]
m      = 10^p1(31);      %    Maintenance term 
K_M    = 10^p1(32);      %    Michaelis menten constant (mmol C cm-3)
a_CO2  = 10^p1(17);      % ** Rate of NER decay
f_1    = 10^p1(33);      %    Conversion factor [carbon/gene]

% FUNCTION PARAMETERS 

Q10      = p1(34);       %    Temperature function constant
